...
// stream of eligibility checks into watch-time deltas. Kept free of DOM,
...
// side-effects (reading focus/visibility, sending YOUTUBE_TICK).
//
...
export interface AccrualStep {
  // Real elapsed watch-time to add to today's total (always >= 0).
  deltaMs: number;
